#!./phg_tcl
#
# $Id: phg.tcl,v 1.14 2014/12/18 07:57:34 zlb Exp $
...
vtkDataSetMapper mapper
  mapper SetInputConnection [phgGrid GetOutputPort]
...
vtkGeometryFilter geom
  geom SetInputConnection [phgGrid GetOutputPort]
...
if {1} {
    axes SetInputConnection [phgGrid GetOutputPort]
...
proc vtk_export {} {
    ...
    vtkUnstructuredGridWriter writer
      writer SetInputConnection [phgGrid GetOutputPort]
...
wm geometry . 900x600
vtkTkRenderWidget .vtkw.ren -rw renWin
::vtk::bind_tk_render_widget .vtkw.ren
pack .vtkw.ren -side top -fill both -expand yes
...
# Note: GetInteractor only created after the object is first drawn.
