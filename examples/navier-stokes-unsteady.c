 ...
 * 
 * $Id: navier-stokes-unsteady.c,v 1.14 2022/03/18 08:59:31 zlb Exp $ */
...
memcpy(s->rhs->data, solver->rhs->data + DofDataCount(u), s->rhs->map->nlocal * sizeof(FLOAT));
s->rhs_updated = TRUE;
